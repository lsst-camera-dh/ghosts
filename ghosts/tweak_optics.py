...
def get_optics_position(telescope, name, i):
    return telescope[name].coordSys.origin[i]


def get_optics_position_x(telescope, name):
    return get_optics_position(telescope, name, 0)


def get_optics_position_y(telescope, name):
    return get_optics_position(telescope, name, 1)


def get_optics_position_z(telescope, name):
    return get_optics_position(telescope, name, 2)
